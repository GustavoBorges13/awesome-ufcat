...
👉 **[Acesse o Editor de Provas Awesome UFCAT](https://SEU-USUARIO.github.io/awesome-ufcat/)**
...
| Ano ou semestre desconhecido | `20XX_1.pdf` ou `2023_X.pdf` |
...
Envie o arquivo diretamente pelo nosso [Formulário do Google](#) *(link em breve)* ou para o e-mail `colocarEmailDps@ufcat.edu.br`.
...
**1. Faça o Fork:**
Clique no botão **"Fork"** no canto superior direito desta página para criar uma cópia do repositório no seu GitHub pessoal. Certifique-se de incluir todas as branches (ou pelo menos a branch `dev`).

**2. Clone para o seu computador:**
Abra o terminal e baixe o **seu** repositório:
```bash
git clone https://github.com/GustavoBorges13/awesome-ufcat.git
cd awesome-ufcat
```
